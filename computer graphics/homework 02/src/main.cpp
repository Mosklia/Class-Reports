...
template<typename T>
static constexpr T deg_to_rad(T deg)
{
                                      ...
                                      float zNear, float zFar)
{
    ...
    Eigen::Matrix4f transform_ortho_1 {
        {1.0f, 0, 0, 0},
        {0, 1.0f, 0, 0},
        {0, 0, 1.0f, (zFar + zNear) / 2},
        {0, 0, 0, 1.0f}
    };

    Eigen::Matrix4f transform_ortho_2 {
        {1.0f / aspect_ratio / zNear / tan(fov_rad / 2), 0, 0, 0},
        {0, 1.0f / zNear / tan(fov_rad / 2), 0, 0},
        {0, 0, 2.0f / (zFar - zNear), 0},
        {0, 0, 0, 1.0f}
    };

    projection = transform_ortho_2 * transform_ortho_1 * transform_persp * projection;
